...
export const ForgetPassword = () => {
  ...
  const submitHandler = (e) => {
    ...
    if (input.password == input.repassword) {
      axios
        .post(`${import.meta.env.VITE_URL}/api/admin/forgetPassword`, {
          email: input.email,
  ...
  return (
    <div className="flex bg-black justify-center items-center h-screen w-screen ">
      ...
      >
        ...
        <button
          type="submit"
          className="border-2 border-blue-600 rounded bg-slate-500 p-2 pl-8 pr-8 relative right-20 text-red-800"
        >
          Submit
        </button>
      </form>
