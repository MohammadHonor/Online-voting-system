    ...
    >
      ...
      <div className="flex flex-col mt-12 gap-4 scroll-my-2">
        {list.list.map((data, index) => {
          return (
            <ul
              className="grid grid-cols-6 w-full pl-4 p-2 bg-stone-300 justify-items-between items-center border-rounder "
              key={index}
            >
              ...
              <li className="flex justify-center relative right-8 ">
                {data.aadharNumber}
              </li>
              <li className="flex justify-center  relative right-6 ">
