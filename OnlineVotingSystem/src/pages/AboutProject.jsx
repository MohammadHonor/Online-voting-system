...
export default function AboutProject(data) {
        ...
        return (
          <>
            <div>
              ...
              tamper proof.We bring the system the is safe,
              <br />
        ...
        return (
          <>
            ...
            <div className="flex  items-center gap-8">
              ...
              <span>Packed by ethereum based technology</span>
            </div>

            <div className="flex  items-center gap-8">
              <IoShieldCheckmarkSharp className="text-4xl" />
              <span>Verifiable transections</span>
            </div>
  ...
  return (
    <div
      className={`${data.color}  relative flex h-screen w-screen justify-center items-center`}
    >
      <div
        className={`flex justify-center  relative  pt-4 ${data.border} border-t-4 relative w-96 rotate-90`}
      >
        <span
          className={`${data.text} text-6xl font-bold absolute rotate-180 `}
        >
          {data.item}
        </span>
      </div>
      <div
        className={` flex   flex-col gap-8 font-bold relative right-20 ${data.text}`}
      >
        {des()}
      </div>
    </div>
...
AboutProject.propTypes = {
  data: PropTypes.shape({
    item: PropTypes.oneOf(["About", "Features"]).isRequired,
