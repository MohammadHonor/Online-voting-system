...
export default function Registration() {
  ...
  const submitHandler = (e) => {
    ...
    axios
      .post(`${import.meta.VITE_URL}/api/v1/voters/register`, {
  ...
  return (
    <div
      className="
        ...
        bg-slate-900 ml-80"
    >
      <div className=" w-96 h-96 text-white ">
        <img
          className="
                rounded shadow-lg 
                shadow-cyan-500/50
        ...
        >
          ...
          <div
            className="flex 
                    flex-col w-80 "
          >
            <label htmlFor="fmName" className="text-white">
              Father/ Mother Name
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col w-80 ">
            <label htmlFor="M-number" className="text-white">
              Mobile Number
            </label>
            <input
              type="text"
          ...
          <div className="flex flex-col w-80 ">
            <label htmlFor="re-pass" className="text-white">
              Re enter password
            </label>
            <input
              type="text"
