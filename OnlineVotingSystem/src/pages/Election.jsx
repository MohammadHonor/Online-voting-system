...
const Election = () => {
  ...
  let sorted_data = initial_data.sort(
    (a, b) => new Date(a.date) - new Date(b.date),
  );
  const [data] = useState(sorted_data);
  ...
  return (
    <div className=" bg-black flex flex-col w-auto h-screen justify-center items-center ">
      <div className=" flex flex-col w-[60rem] p-10 gap-[2rem]  ">
        ...
        <div className="flex  items-center bg-slate-300 p-[.5rem] justify-between rounded">
        ...
        <div className="flex justify-between items-center bg-slate-300 p-[.5rem] w-auto rounded ">
