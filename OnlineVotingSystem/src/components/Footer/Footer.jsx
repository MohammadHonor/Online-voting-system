...
const Footer = (color) => {
  return (
    <div className=" bg-slate-900 grid justify-items-stretch gap-2 border-t-2 border-solid border-white grid-cols-3 p-20 pl-32">
      <div className=" border-blue-900 flex flex-col gap-4  border-r-2">
      ...
      <div className="grid justify-items-start border-r-2 border-solid border-blue-900">
        <div className="flex  gap-8 text-white">
          <span className="flex flex-col ">
            ...
            <NavLink to="/Registration" className={`font-bold`}>
              Register
            </NavLink>
          ...
          <span className="flex flex-col">
            ...
            <NavLink to="/features" className={`font-bold`}>
              Featues
            </NavLink>
            <NavLink to="/Steps" className={`font-bold`}>
              Steps
            </NavLink>
          </span>
          <span className="flex flex-col">
        ...
        <p className="font-bold text-center text-white">
          Created by Mohammad Sharuf Ali
        </p>
      </div>
      <div className="flex flex-col  gap-2">
        ...
        <div className="flex  justify-end">
          <button className=" bg-blue-500 text-white  text-2xl w-28">
            <IoIosSend className="text-white text-4xl inline-block " />
            Send
          </button>
        </div>
      </div>
