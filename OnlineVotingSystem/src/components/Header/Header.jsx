...
export default function Header() {
    return <div>
        <div className=" bg-slate-900 p-10 h-screen flex items-center justify-center gap-10">
            ...
            <div className="grid grid-cols-2 gap-36 ">
             ...
             shadow-cyan-500/80 rounded shadow-xl"
                ...
                <div className="  flex flex-col  gap-6  text-neutral-50 justify-center w-auto h-auto">
                    <span className=" font-bold text-3xl duration-75">Be a part of decision</span>
