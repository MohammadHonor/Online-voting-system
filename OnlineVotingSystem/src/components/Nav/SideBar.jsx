...
const SideBar = () => {
  ...
  return (
    <>
      <div
        className="mt-20 fixed pt-10 pl-5   
       bg-blue-950
      text-white w-20 h-full 
      z-50
      overflow-y-scroll
      overflow-x-hidden
      hover:w-60 
        ...
        >
         ...
         hover:bg-green-500/50 w-48 rounded p-2"
          ...
          >
            ...
            <NavLink to="/userLogin" onClick={notify1}>
              User
            </NavLink>
            <ToastContainer />
          </li>
         ...
         hover:bg-green-500/50 w-48 rounded p-2"
          >
            ...
            <NavLink to="/adminLogin" onClick={notify2}>
              Admin
            </NavLink>
            <ToastContainer />
          </li>
         ...
         hover:bg-green-500/50 w-48 rounded p-2"
          >
            ...
            <NavLink to="/About" onClick={notify3}>
              About
            </NavLink>
            <ToastContainer />
          </li>
         ...
         hover:bg-green-500/50 w-48 rounded p-2"
          >
            ...
            <NavLink to="/Contact" onClick={notify4}>
              Contact
            </NavLink>
            <ToastContainer />
          </li>
         ...
         hover:bg-green-500/50 w-48 rounded p-2"
          >
            ...
            <NavLink to="/Features" onClick={notify4}>
              Features
            </NavLink>
          </li>
        </ul>
